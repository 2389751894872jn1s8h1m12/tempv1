// dont skid thanku :) credits to xkt and btc and w
...
(async () => {
    ...
    if (console.log("%c Blooket Helper %c\n	By xkt", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), console.log("%c	gui.js", "color: #0bc2cf; font-size: 1rem"), console.log("%c	add me on cord xkt!%c  ", "color: #ffd000; font-size: 1rem", ""), document.querySelector("script[src*='bfs/index.js']") && !window.clearId) {
    ...
    let p,
        ...
        _ = l("div", {
            ...
            innerHTML: "Discord - xkt",
            onclick: () => window.open("https://discord.com/user", "_blank").focus()
        }), $ = l("div", {
            id: "controlButtons",
            style: {
                display: "flex",
            ...
            innerHTML: '<span style="text-shadow: 1px 1px rgb(0 0 0 / 40%); font-size: 0.8em;">Blooket Helper<sup>v0.1BETA</sup></span>'
        }, l("a", {
            className: "bigButton",
            style: {
                cursor: "pointer",
            ...
            target: "_blank",
            href: "https://discord.com/user/504625649022009345",
    ...
    async function k(e, t, a) {
        b.innerHTML = "",
            v.firstChild.innerText = e + (a ? "" : " Blooket helper"),
            b.append(v);
    ...
    let C = {
        ...
        credits: [{
            element: l("div", {
                ...
                const creditsList = [{
                    name: "xkt",
                    description: "Founder of <a href='https://stabbed.lol' target='_blank' style='color: #0000FF;'>Blooket Helper is xkt</a>"
                }, {
                    name: "BTC",
                    description: "Co-Founder of Blooket Helper"
                }, {
                    name: "W",
                    description: "Creator of the GUI and old GUI"
        ...
        alerts: [{
            element: l("div", {
                ...
                innerText: "[LOG] GUI opened have fun from xkt"
            })))),
            addLog(e, t) {
